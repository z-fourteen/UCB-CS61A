...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        place, trans = self.place, 0
        while not place.is_hive and trans <= self.upper_bound:
            print('Debug: trans=', trans)
            if trans >= self.lower_bound:
                if place.bees:
                    print('Debug: target =', place.name)
    ...
    def action(self,gamestate):
        if self.cooldown == 0:
            ...
            if bee:
                ...
                self.eaten_flag = True
            else:
                self.eaten_flag = False
        if self.eaten_flag:
            self.cooldown = (self.cooldown + 1) % (self.chew_cooldown + 1)
# END Problem 7
...
class TankAnt(ContainerAnt):
    ...
    def action(self, gamestate):
        ...
        self.reduce_health(self.damage)
...
class QueenAnt(ThrowerAnt):
    ...
    def reduce_health(self, amount):
        ...
        # BEGIN Problem 12
        ants_lose()
        return ThrowerAnt.reduce_health(self, amount)
        # END Problem 12
